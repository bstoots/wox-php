...
class SimpleReader implements ObjectReader {
  ...
  public function __construct(array $init = []) {
    if (array_key_exists('classMap', $init)) {
      $this->classMap = $init['classMap'];
    }
  }

  public function read($xob)/*: Object*/ {
    $this->initialize();
   ...
   */
  public function readElement(/*Element*/ $xob)/*: Object*/ {
   ...
   */
  private function reference(/*Element*/ $xob): bool {
   ...
   */
  private function readObject(/*Element*/ $xob, /*Object*/ $id)/*: Object*/ {
      ...
      // try {
          ...
          // $ob = makeObject(cons, new Object[0], id);
  ...
  private function makeObject(/*Constructor*/ $cons, /*Object[]*/ $args, /*Object*/ $key)/*: Object */ {
